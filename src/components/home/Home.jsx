    ...
    <div className="container home__container">
      <div className="home__content__container">
        ...
        <div className="img__container">
          ...
          <a href="https://www.upwork.com/freelancers/~018f0a3f855d9f92d9" target='_blank' rel="noreferrer" className="h-max rounded-full flex justify-center items-center absolute -bottom-5 md:top-0 flex-col md:flex-row -right-2 text-gray-300 md:translate-x-[50%] cursor-pointer hover:scale-110 transition-all duration-300">
